-- Reconcile the moderated product reviews schema when migration history is unavailable
-- and the table and summary function have both been verified as missing.
begin;
...
create function public.get_product_review_summary(p_product_id uuid)

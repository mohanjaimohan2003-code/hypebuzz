...
const title = "Compare Products | HypeBuzz";
...
export const metadata:Metadata={title,description,alternates:{canonical},openGraph:{type:"website",title,description,url:canonical,siteName:"HypeBuzz"},twitter:{card:"summary_large_image",title,description}};
